...
dfs2 = pd.read_csv('Cp_Ct/Experiment_Summary.csv', sep = ';')
...
ev08Pxxx = [v08[v08['Reletive Position'] == 'xxx']['Cp +'] - v08[v08['Reletive Position']=='xxx']['Cp'].astype(float), \
           v08[v08['Reletive Position']=='xxx']['Cp'].astype(float) - v08[v08['Reletive Position'] == 'xxx']['Cp -']]
#plot and save Cp for velocity of v=0.8m/s
plt.xlabel('TSR')
plt.ylabel('$C_P$')
plt.plot(v08[v08['Reletive Position']=='xxx']['TSR'].astype(float), v08[v08['Reletive Position']=='xxx']['Cp'].astype(float), '-D', markevery=[3], label = 'Without Mast')
plt.plot(v08[v08['Reletive Position']=='594,000']['TSR'].astype(float), v08[v08['Reletive Position']=='594,000']['Cp'].astype(float), '-D', markevery=[3], label = '594 mm')
plt.plot(v08[v08['Reletive Position']=='427,000']['TSR'].astype(float), v08[v08['Reletive Position']=='427,000']['Cp'].astype(float), '-D', markevery=[3], label = '427 mm')
plt.plot(v08[v08['Reletive Position']=='260,000']['TSR'].astype(float), v08[v08['Reletive Position']=='260,000']['Cp'].astype(float), '-D', markevery=[3],label = '260 mm')
plt.plot(v08[v08['Reletive Position']=='93,000']['TSR'].astype(float), v08[v08['Reletive Position']=='93,000']['Cp'].astype(float), label = '93 mm')
plt.legend(loc = 'lower right')
plt.grid(True)
plt.show()
...
plt.xlabel('TSR')
plt.ylabel('$C_t$')
plt.plot(v08[v08['Reletive Position']=='xxx']['TSR'].astype(float), v08[v08['Reletive Position']=='xxx']['Ct'].astype(float), '-D', markevery=[3], label = 'Without Mast')
plt.plot(v08[v08['Reletive Position']=='594,000']['TSR'].astype(float), v08[v08['Reletive Position']=='594,000']['Ct'].astype(float), '-D', markevery=[3], label = '594 mm')
plt.plot(v08[v08['Reletive Position']=='427,000']['TSR'].astype(float), v08[v08['Reletive Position']=='427,000']['Ct'].astype(float), '-D', markevery=[3], label = '427 mm')
plt.plot(v08[v08['Reletive Position']=='260,000']['TSR'].astype(float), v08[v08['Reletive Position']=='260,000']['Ct'].astype(float), '-D', markevery=[3],label = '260 mm')
plt.plot(v08[v08['Reletive Position']=='93,000']['TSR'].astype(float), v08[v08['Reletive Position']=='93,000']['Ct'].astype(float), label = '93 mm')
plt.legend(loc = 'lower right')
plt.grid(True)
plt.show()
...
#plot and save Cp for velocity of v=1 m/s
plt.xlabel('TSR')
plt.ylabel('$C_P$')
plt.plot(v10[v10['Reletive Position']=='xxx']['TSR'].astype(float), v10[v10['Reletive Position']=='xxx']['Cp'].astype(float), '-D', markevery=[3], label = 'Without Mast')
plt.plot(v10[v10['Reletive Position']=='594,000']['TSR'].astype(float), v10[v10['Reletive Position']=='594,000']['Cp'].astype(float),  '-D', markevery=[3], label = '594 mm')
plt.plot(v10[v10['Reletive Position']=='427,000']['TSR'].astype(float), v10[v10['Reletive Position']=='427,000']['Cp'].astype(float),  '-D', markevery=[3], label = '427 mm')
plt.plot(v10[v10['Reletive Position']=='260,000']['TSR'].astype(float), v10[v10['Reletive Position']=='260,000']['Cp'].astype(float),  '-D', markevery=[3], label = '260 mm')
plt.plot(v10[v10['Reletive Position']=='93,000']['TSR'].astype(float), v10[v10['Reletive Position']=='93,000']['Cp'].astype(float), label = '93 mm')
plt.legend(loc = 'lower right')
plt.grid(True)
plt.show()
...
plt.xlabel('TSR')
plt.ylabel('$C_t$')
plt.plot(v10[v10['Reletive Position']=='xxx']['TSR'].astype(float), v10[v10['Reletive Position']=='xxx']['Ct'].astype(float), '-D', markevery=[3], label = 'Without Mast')
plt.plot(v10[v10['Reletive Position']=='594,000']['TSR'].astype(float), v10[v10['Reletive Position']=='594,000']['Ct'].astype(float),  '-D', markevery=[3], label = '594 mm')
plt.plot(v10[v10['Reletive Position']=='427,000']['TSR'].astype(float), v10[v10['Reletive Position']=='427,000']['Ct'].astype(float),  '-D', markevery=[3], label = '427 mm')
plt.plot(v10[v10['Reletive Position']=='260,000']['TSR'].astype(float), v10[v10['Reletive Position']=='260,000']['Ct'].astype(float),  '-D', markevery=[3], label = '260 mm')
plt.plot(v10[v10['Reletive Position']=='93,000']['TSR'].astype(float), v10[v10['Reletive Position']=='93,000']['Ct'].astype(float), label = '93 mm')
plt.legend(loc = 'lower right')
plt.grid(True)
plt.show()
...
#plot and save Cp for velocity of v=1.2 m/s
plt.xlabel('TSR')
plt.ylabel('$C_P$')
plt.plot(v12[v12['Reletive Position']=='xxx']['TSR'].astype(float), v12[v12['Reletive Position']=='xxx']['Cp'].astype(float), '-D', markevery=[3,4], label = 'Without Mast')
plt.plot(v12[v12['Reletive Position']=='594,000']['TSR'].astype(float), v12[v12['Reletive Position']=='594,000']['Cp'].astype(float),  '-D', markevery=[3, 4], label = '594 mm')
plt.plot(v12[v12['Reletive Position']=='427,000']['TSR'].astype(float), v12[v12['Reletive Position']=='427,000']['Cp'].astype(float),  '-D', markevery=[3], label = '427 mm')
plt.plot(v12[v12['Reletive Position']=='260,000']['TSR'].astype(float), v12[v12['Reletive Position']=='260,000']['Cp'].astype(float),  '-D', markevery=[3], label = '260 mm')
plt.plot(v12[v12['Reletive Position']=='93,000']['TSR'].astype(float), v12[v12['Reletive Position']=='93,000']['Cp'].astype(float), label = '93 mm')
plt.legend(loc = 'lower right')
plt.grid(True)
plt.show()
...
plt.xlabel('TSR')
plt.ylabel('$C_t$')
plt.plot(v12[v12['Reletive Position']=='xxx']['TSR'].astype(float), v12[v12['Reletive Position']=='xxx']['Ct'].astype(float), '-D', markevery=[3, 4], label = 'Without Mast')
plt.plot(v12[v12['Reletive Position']=='594,000']['TSR'].astype(float), v12[v12['Reletive Position']=='594,000']['Ct'].astype(float),  '-D', markevery=[3, 4], label = '594 mm')
plt.plot(v12[v12['Reletive Position']=='427,000']['TSR'].astype(float), v12[v12['Reletive Position']=='427,000']['Ct'].astype(float),  '-D', markevery=[3], label = '427 mm')
plt.plot(v12[v12['Reletive Position']=='260,000']['TSR'].astype(float), v12[v12['Reletive Position']=='260,000']['Ct'].astype(float),  '-D', markevery=[3], label = '260 mm')
plt.plot(v12[v12['Reletive Position']=='93,000']['TSR'].astype(float), v12[v12['Reletive Position']=='93,000']['Ct'].astype(float), label = '93 mm')
plt.legend(loc = 'lower right')
plt.grid(True)
plt.show()
