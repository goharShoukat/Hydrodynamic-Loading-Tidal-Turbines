...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.combo_box.addItems(['RPM','Thrust', 'Torque', 'Fx1', 'Fy1', 'Mx1', 'My1', 'Mz1', 'Fx2', 'Fy2', 'Mx2', 'My2', 'Mz2', 'Fx3', 'Fy3', 'Mx3', 'My3', 'Mz3'])
        ...
        self.setWindowTitle("Dashboard old format")
    ...
    def readFile(self):
        ...
        self.df = data_import_func_old.access_file(self.filename, self.total_time, self.sampl_freq)
    ...
    def plot(self):
        ...
        self.df2 = data_import_func.mean_force_angle(self.theta, self.df[self.content].to_numpy())
        '''
        #fit for averaging
        coeff = np.polyfit(self.theta, self.df[self.content].to_numpy(), 4)
        f = np.poly1d(coeff)
        self.y_new = f(self.theta)
        '''
        self.ax4.clear()
        ...
        self.ax4.scatter(self.theta, self.df[self.content], s = 0.01, alpha = 0.75)
        self.ax4.scatter(self.df2['theta'], self.df2['signal'])
    ...
    def window3(self):
        ...
        self.ax5.scatter(self.theta, self.df[self.content], s = 0.01, alpha = 0.75)
        #self.ax5.scatter(self.theta, self.y_new, s = 0.5, alpha = 1)
        self.ax5.scatter(self.df2['theta'], self.df2['signal'])
